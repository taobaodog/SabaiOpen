...
<script type='text/javascript'>
		...
		function saveEdit(){ 
			...
			E("_act").value='save'; 
			que.drop( "bin/ovpn.php", OVPNresp, $("#fe").serialize() );
		}
...
<body onload='init();' id='topmost'>
						...
						<input type='button' value='Upload' onclick='OVPNsave("newfile");'></span>
...
<div class='controlBox'><span class='controlBoxTitle'>OpenVPN Settings</span>
	<div class='controlBoxContent'>
<body onload='init();' id='topmost'>
<form id="fe" method='post' action='bin/ovpn.php' encType='multipart/form-data'>
	<span id='ovpn_file'></span>
		<p>
			<span id='upload'>
			<input type='file' id='file' name='file'>
